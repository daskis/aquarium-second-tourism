# Generated by Django 5.0.4 on 2024-04-19 22:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('facility', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dashboard.facility')),
                ('stock', models.ManyToManyField(blank=True, to='dashboard.stock')),
            ],
            options={
                'ordering': ['name'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=100)),
                ('tariff', models.CharField(choices=[('basic', 'Basic'), ('premium', 'Premium')], max_length=100)),
